...
<head>
    ...
    <title>{{ config('app.name', 'W3University') }}</title>
...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-0 items-center lg:justify-center min-h-screen flex-col">
    ...
    <!-- resources/views/hero.blade.php (or paste into your Blade file) -->
    <div class="w3-hero">
        <div class="w3-hero__overlay"></div>

        <!-- decorative floating blobs -->
        <div class="w3-blob w3-blob--a"></div>
        <div class="w3-blob w3-blob--b"></div>
        <div class="w3-blob w3-blob--c"></div>

        <!-- subtle star/particle layer (pure-CSS) -->
        <div class="w3-particles" aria-hidden="true"></div>
    ...
    <style>
        ...
        .w3-hero {
            ...
            background: linear-gradient(120deg, #0f172a 0%, #0b1220 35%, #031026 100%);
        }
        ...
        @keyframes overlayShift {
            ...
            50% {
                transform: translateY(-6%) scale(1.05) rotate(0.5deg);
            }
        ...
        .w3-blob--a {
            width: 520px;
            height: 520px;
            background: radial-gradient(circle at 30% 30%, #5eead4, #06b6d4 40%, transparent 60%);
            top: -12%;
            left: -10%;
            animation: blobMoveA 18s ease-in-out infinite;
        }

        .w3-blob--b {
            width: 420px;
            height: 420px;
            background: radial-gradient(circle at 70% 20%, #a78bfa, #7c3aed 40%, transparent 60%);
            bottom: -10%;
            right: -14%;
            animation: blobMoveB 22s ease-in-out infinite;
        }

        .w3-blob--c {
            width: 300px;
            height: 300px;
            background: radial-gradient(circle at 50% 60%, #fca5a5, #fb7185 30%, transparent 60%);
            top: 10%;
            right: 6%;
            animation: blobMoveC 20s ease-in-out infinite;
        }
        ...
        @keyframes blobMoveA {
            ...
            50% {
                transform: translate(8%, -6%) scale(1.06) rotate(3deg);
            }
        ...
        @keyframes blobMoveB {
            ...
            50% {
                transform: translate(-6%, 5%) scale(1.04) rotate(-2deg);
            }
        ...
        @keyframes blobMoveC {
            ...
            50% {
                transform: translate(-4%, -8%) scale(1.08) rotate(2deg);
            }
        ...
        /* particle layer using repeating linear-gradients + small pseudo dots */
        .w3-particles {
            position: absolute;
            inset: 0;
            z-index: 2;
            ...
            background-image:
                ...
                radial-gradient(1.5px 1.5px at 85% 10%, rgba(255, 255, 255, 0.04) 50%, transparent 51%),
                radial-gradient(1px 1px at 55% 80%, rgba(255, 255, 255, 0.03) 50%, transparent 51%),
                radial-gradient(1.2px 1.2px at 40% 45%, rgba(255, 255, 255, 0.05) 50%, transparent 51%);
        ...
        @keyframes particleDrift {
            ...
            to {
                transform: translateY(-40px) translateX(20px) rotate(0.01turn);
            }
        }

        /* Content centered above layers */
        .w3-hero__content {
            position: relative;
            z-index: 3;
            text-align: center;
        ...
        /* Title styling -- neon/glow + entrance animation */
        .w3-hero__title {
            margin: 0;
            ...
            padding: 0 0.25rem;
            transform-origin: center;
            animation: titlePop 1.1s cubic-bezier(.2, .9, .2, 1) both;
            -webkit-font-smoothing: antialiased;
            text-shadow:
                0 2px 8px rgba(2, 6, 23, 0.6),
                0 0 30px rgba(14, 165, 233, 0.08),
                0 0 14px rgba(124, 58, 237, 0.06);
        }

        /* slight shimmer/flicker on the text (subtle) */
        .w3-hero__title::after {
            content: "";
            position: absolute;
            inset: 0;
        ...
        .w3-hero__subtitle {
            ...
            font-weight: 500;
            opacity: 0.95;
            animation: fadeUp 1.2s ease both 0.25s;
        }
        ...
        .w3-hero__cta {
            ...
            border-radius: 12px;
            background: linear-gradient(90deg, rgba(124, 58, 237, 0.12), rgba(14, 165, 233, 0.18));
            color: #fff;
            font-weight: 600;
            ...
            animation: fadeUp 1.2s ease both 0.35s;
        }

        .w3-hero__cta:hover {
            transform: translateY(-4px);
            box-shadow: 0 14px 42px rgba(2, 6, 23, 0.6);
        }
