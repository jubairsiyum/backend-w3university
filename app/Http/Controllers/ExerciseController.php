...
class ExerciseController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'instructions_bn' => 'required|string',
            'difficulty' => 'required|string|max:255',
            'difficulty_bn' => 'required|string|max:255',
    ...
    public function update(Request $request, $slug)
    {
        ...
        $validated = $request->validate([
            ...
            'instructions_bn' => 'sometimes|required|string',
            'difficulty' => 'sometimes|required|string|max:255',
            'difficulty_bn' => 'sometimes|required|string|max:255',
            'duration' => 'nullable|integer',
            'duration_bn' => 'nullable|string|max:50',
